...
public typealias CustomTableViewEventBlock = (_: UIView?, _ : Any?) -> Void

@objc public protocol CustomTableViewDelegate : NSObjectProtocol {
    
    /// 代理事件
    func customTableView(_ tableView: CustomTableView, eventView: UIView?, event: Any?)
}

open class CustomTableView: UIView, UITableViewDelegate, UITableViewDataSource, BaseTableViewCellDelegate, BaseTableViewHeaderFooterViewDelegate {
    ...
    /// 事件代理
    open weak var delegate : CustomTableViewDelegate?
    
    /// 事件block
    open var eventBlock : CustomTableViewEventBlock?
    ...
    open var isSticky : Bool { get { return sticky}}
    
    /// tableView
    open var tableView : UITableView { get { return privateTableView!}}
    ...
    required public init(frame: CGRect, autoLayout : Bool = true, sticky : Bool = true) {
    ...
    /// tableView重新加载数据
    open func reloadData() { privateTableView!.reloadData()}
    
    
    /// 添加block事件的方法
    /// - Parameter block: block对象
    open func addEventBlock(_ block : @escaping CustomTableViewEventBlock) {
    ...
    open func baseTableViewCell(_ cell: BaseTableViewCell?, event: Any?) {
    ...
    open func baseTableViewHeaderFooterView(_ headerFooterView: BaseTableViewHeaderFooterView?, event: Any?) {

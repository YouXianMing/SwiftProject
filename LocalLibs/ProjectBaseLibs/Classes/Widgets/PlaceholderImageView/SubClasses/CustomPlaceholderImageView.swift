//
//  CustomPlaceholderImageView.swift
...
open class CustomPlaceholderImageView: PlaceholderImageView {
    ...
    /// 通用类型的占位图,你可以在BasePlaceholderViewConfig的子类中进行定制
    ...
    open override var placeholderView: UIView { get { return customView}}
